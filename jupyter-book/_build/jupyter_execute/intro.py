...
# 중요성이 매우 높아졌다.
# 자율주행, 의료영상, 농업, 교육, 재난 예방, 제조업 등 
# 사회, 경제, 산업의 거의 모든 분야에서 머신러닝/딥러닝의 활용이 점차 강조되어 왔으며
# 이런 경향이 앞으로 더욱 강화될 것으로 기대된다.
# 
# 또한 약간의 코딩 지식을 가진 어느 누구나 
# 데이터로부터 학습하는 스마트 앱을 개발 할 수 있을 정도로
# 머신러닝/딥러닝 기술이 이미 많이 대중화되었다.
# 
# 여기서는 딥러닝의 기본 개념과 함께 다양한 딥러닝 기법을 최대한 직관적으로 
# 전달하는 일에 집중한다.
# 이를 위해 다양한 예제와 적절한 코드를 이용한다.
