...
# **알고리즘**
# 
# 2000년대 후반까지 소위 **역전파 문제**로 인해 딥러닝의 심층 신경망을 효율적으로 훈련시킬 수 있는 
# 알고리즘이 알려지지 않았다.
# 2010년을 전후해서 역전파 문제 해결에 도움이 되는 알고리즘과 기법이 개발되었다. 
# 
...
# 
# 그 결과 현재 수십 개의 층을 가지며 수천 만개의 가중치(파라미터)를 갖는
# 심층 신경망을 훈련시킬 수 있게 되었다.
